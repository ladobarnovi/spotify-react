function IconHomeHollow() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" role="img" height="24" width="24" aria-hidden="true"
         className="Svg-sc-ytk21e-0 haNxPq home-icon" viewBox="0 0 24 24" data-encore-id="icon">
      <path
